...
%\clearpage
\begin{tabbing}
\textbf{Exercise 1.} \= Use the definition of difference quotient to find the slope of the \textbf{secant} line through \\ \> $y=f(x)=\frac58(x-1)^4+15$ between $x$ and $x+h$. \\[1ex]
\textbf{Exercise 2.} Use the definition of difference quotient to find the slope of the \textbf{tangent} line to \\ \> $y=f(x)=\frac58(x-1)^4+15$ at $x$. \\[1ex]
...
\textbf{Exercise 3.} Use the \textbf{diagram} to estimate the slope of the \textbf{secant} line to \\ \> $y=f(x)=\frac58(x-1)^4+15$ between 3 and 5. \\[1ex]
\textbf{Exercise 4.} Use your answer to Exercise 2 above to estimate the slope of the \textbf{tangent} line to \\ \> $y=f(x)=\frac58(x-1)^4+15$ at 3.
\end{tabbing}
\end{minipage}
