...
\vspace{\stretch2}
\(	\displaystyle \phantom{\lim_{\textstyle h\to\phantom{\text{\huge0}}}}
	\frac{\phantom{f(x+h)-f(x)}}{} 
	\hspace{0.25ex}
	\mathrlap{
		= \stacktwo{slope of}{secant} 
		= \stacktwo{difference}{quotient}
		= \stackthree{average}{rate of}{change}
		= \stacktwo{average}{velocity} % \text{if $y$ = position, $x$ = time}
		}
	\)

\vspace{\stretch2}
\(	\displaystyle {\lim_{\textstyle h\to\phantom{\text{\huge0}}}}
	\frac{\phantom{f(x+h)-f(x)}}{} 
	\hspace{0.25ex}
	\mathrlap{
